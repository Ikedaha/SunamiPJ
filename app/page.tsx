...
return (
<div style={{ textAlign: "center", fontFamily: "serif", background: "#faf8f5", paddingBottom: 40 }}>
...
<p style={{ fontSize: 18, marginTop: -10 }}>大切な仲間とともに祝う特別なひととき</p>


{/* --- Date Section --- */}
<h2 style={{ marginTop: 40 }}>📅 日時</h2>
<p style={{ fontSize: 20 }}>2025年11月22日（土）</p>
<p style={{ fontSize: 16, marginTop: -10 }}>当日は角南の自宅までお迎えに上がります。</p>


{/* --- Venue Section --- */}
<h2 style={{ marginTop: 40 }}>📍 会場（仮）</h2>
<p style={{ fontSize: 20 }}>HARBOR VIEW HALL AKASHI（仮名）</p>
<p style={{ fontSize: 14, marginTop: -10 }}>※会場は後ほど正式にご案内します</p>
...
<a href="https://forms.gle/example" target="_blank" style={{ fontSize: 18 }}>
Google Form
</a>
</div>
);
